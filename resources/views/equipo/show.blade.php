...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center flex-column" style="height: calc(100vh - 56px);">
        ...
        <div class="w-25">
            ...
            <div class="form-floating mb-3">
                <input name="codigo" type="number" class="form-control" id="codigo" value="{{$equipo->codigo}}" disabled>
            ...
            <div class="form-floating mb-3">
                <input name="aforo" type="text" class="form-control" id="aforo" value="{{$equipo->aforo}}" disabled>
                <label for="aforo">Aforo</label>
            </div>
            <div class="form-floating mb-3">
                <input name="año" type="number" class="form-control" id="año" value="{{$equipo->año}}" disabled>
