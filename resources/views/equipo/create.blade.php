...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center flex-column" style="height: calc(100vh - 56px);">
        ...
        <form class="w-25" action="{{route('equipo.store')}}" method="POST">
            ...
            <div class="form-floating mb-3">
                <input name="ciudad" type="text" class="form-control" id="ciudad" placeholder="Dirección">
            ...
            <div class="form-floating mb-3">
                <input name="aforo" type="number" class="form-control" id="aforo" placeholder="aforo">
                <label for="aforo">Aforo</label>
            </div>
            <div class="form-floating mb-3">
                <input name="año" type="number" class="form-control" id="año" placeholder="año">
